...
def main() -> None:
    ...
    if "Acces deschis" not in html or "guest-supabase.js" not in html:
        raise RuntimeError("guest UI markers are missing")
    path.write_text(html, encoding="utf-8")
    print(f"Enabled temporary guest UI in {path}")
